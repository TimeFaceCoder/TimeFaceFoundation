...
//    self.tableRefreshView = [[TFTableRefreshView alloc] initWithFrame:CGRectMake((self.width - 100)/2, 0, 100, self.height)];
//    [self addSubview:self.tableRefreshView];
}
...
- (void)setProgress:(double)progress
{
    ...
    [self.tableRefreshView startPullWithProgress:_progress];
